	...
	<div class="row">
		<div class="col-3"></div>
			<div class="col-6">
				<div class="col-9">
					<h1>게시글 쓰기</h1>
					<form action="${root }/article/write.do" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<textarea name="content" id="textarea1-content" cols="30"
								rows="10" class="form-control">${param.content }</textarea>
						</div>
<!-- 						<div class="form-group">
							<label for="textarea1-content">사진</label>
